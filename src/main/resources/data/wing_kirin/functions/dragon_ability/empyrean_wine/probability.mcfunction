...
# 根据等级设置参数
# 1级：1%
execute if data storage wing_kirin:ram {empyrean_wine:{level:1}} if predicate wing_kirin:1_percent run function wing_kirin:dragon_ability/empyrean_wine/modify_item
# 2级：3%
execute if data storage wing_kirin:ram {empyrean_wine:{level:2}} if predicate wing_kirin:3_percent run function wing_kirin:dragon_ability/empyrean_wine/modify_item
# 3级：5%
execute if data storage wing_kirin:ram {empyrean_wine:{level:3}} if predicate wing_kirin:5_percent run function wing_kirin:dragon_ability/empyrean_wine/modify_item
# 4级：7%
execute if data storage wing_kirin:ram {empyrean_wine:{level:4}} if predicate wing_kirin:7_percent run function wing_kirin:dragon_ability/empyrean_wine/modify_item
# 5级：9%
