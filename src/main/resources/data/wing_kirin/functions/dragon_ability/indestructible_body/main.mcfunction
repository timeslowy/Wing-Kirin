...
# 自身产生反撞粒子特效
particle dust 0.98 0.86 0.57 4.0 ~ ~ ~ 0.5 0.5 0.5 1 50

# 通过属性巨龙技能伤害数值计算伤害
# execute store result storage wing_kirin:ram indestructible_body.countershock_damage float 1 run attribute @s dragonsurvival:dragon_ability_damage get 4
