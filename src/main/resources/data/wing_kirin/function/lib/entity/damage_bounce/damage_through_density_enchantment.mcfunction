...
execute unless data entity @s SelectedItem.components."minecraft:enchantments".minecraft:density run return fail
...
execute store result score result wk.math run data get entity @s \
    SelectedItem.components."minecraft:enchantments"."minecraft:density"
