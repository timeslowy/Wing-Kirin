# 判断是否已拥有此技能
execute store success score @s wk.ability_add.has_ability run dragon-ability query @s dragonsurvival:invincible_benevolence level
...
# 获得《仁者无敌》技能
dragon-ability add @s dragonsurvival:invincible_benevolence
