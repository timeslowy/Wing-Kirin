# 判断是否已拥有此技能
execute store success score @s wk.ability_add.has_ability run dragon-ability query @s dragonsurvival:last_stand level
...
# 获得《回光返照》技能
dragon-ability add @s dragonsurvival:last_stand

# 动作栏显示获得信息
title @s actionbar [{"translate": "actionbar.wing_kirin.upgrade.describiton_0"}, \
    {"translate": "actionbar.wing_kirin.upgrade.last_stand.describiton_1","color": "#fbdc92"}]
