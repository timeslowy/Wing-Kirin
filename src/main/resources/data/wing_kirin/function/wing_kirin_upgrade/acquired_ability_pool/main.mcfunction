...
execute if score @s wk.ability_add.random_value matches 1..8 run return \
    run function wing_kirin:wing_kirin_upgrade/acquired_ability_pool/signal_arrow

# 检查7%（9-15）概率执行函数B （获得技能：聚形散气）
execute if score @s wk.ability_add.random_value matches 9..15 run return \
    run function wing_kirin:wing_kirin_upgrade/acquired_ability_pool/instant_invisibility

# 检查6%（16-21）概率执行函数C （获得技能：仁者无敌）
execute if score @s wk.ability_add.random_value matches 16..21 run return \
    run function wing_kirin:wing_kirin_upgrade/acquired_ability_pool/invincible_benevolence

# 检查5%（22-26）概率执行函数C （获得技能：唯快不破）
execute if score @s wk.ability_add.random_value matches 22..26 run return \
    run function wing_kirin:wing_kirin_upgrade/acquired_ability_pool/unstoppable_speed
