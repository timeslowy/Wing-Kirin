...
/**
 * 金风玉露（自 1.21.1 NeoForge 分支移植）。
 * 1.20.1 的 FoodProperties.Builder 无 usingConvertsTo（1.20.5+ 才有），
 * "吃完返还玻璃瓶"改由 finishUsingItem 手动实现（参照原版 HoneyBottleItem）。
 */
public class EmpyreanWineItem extends Item {
    ...
    // 添加描述（1.20.1 签名第二参数为 Level，非 TooltipContext）
    @Override
