...
public class PackFinders {
    ...
    public static void addPackFinders(@NotNull AddPackFindersEvent event) {
        ...
        event.addPackFinders(
                Identifier.fromNamespaceAndPath(Wing_kirin.MOD_ID, "assets/wing_kirin/resourcepacks/original_fly_animation"),
                PackType.CLIENT_RESOURCES,
        ...
        event.addPackFinders(
                Identifier.fromNamespaceAndPath(Wing_kirin.MOD_ID, "assets/wing_kirin/resourcepacks/simple_description"),
                PackType.CLIENT_RESOURCES,
