...
public class WKServerConfig {
    ...
    /** 定身效果是否禁用龙玩家主动技能 */
    public static final ForgeConfigSpec.BooleanValue DING_SHEN_DISABLE_ABILITIES;

    /** 定身效果是否禁用龙玩家被动技能 */
    public static final ForgeConfigSpec.BooleanValue DING_SHEN_DISABLE_PASSIVE_ABILITIES;

    /** 定身效果是否禁用玩家交互 */
    public static final ForgeConfigSpec.BooleanValue DING_SHEN_DISABLE_INTERACTION;

    /** 定身效果每刻随机关闭GUI的概率（0-100） */
    public static final ForgeConfigSpec.IntValue DING_SHEN_CLOSE_GUI_CHANCE;

    /** 定身效果是否禁用玩家视角旋转 */
    public static final ForgeConfigSpec.BooleanValue DING_SHEN_DISABLE_LOOK_ROTATION;

    /** 定身效果是否完全锁定实体位置（禁止任何移动、传送与维度切换） */
    public static final ForgeConfigSpec.BooleanValue DING_SHEN_LOCK_POSITION;

    /** 粉碎定身时是否为非翼麒麟龙玩家提供「不破不立」增益（生命恢复Ⅱ10秒）；关闭时仅翼麒麟可获得 */
    public static final ForgeConfigSpec.BooleanValue SHATTER_BUFF_FOR_NON_WING_KIRIN;

    /** 定身粉碎阈值：单次受到的伤害超过最大血量的该比例时，定身效果被"粉碎"（0-1，默认0.3） */
    public static final ForgeConfigSpec.DoubleValue DING_SHEN_SHATTER_RATIO;

    /** 浩然正气是否使翼麒麟无视法力消耗 */
    public static final ForgeConfigSpec.BooleanValue GREAT_ZHENGQI_IGNORE_MANA_COST;

    /** 唯快不破是否对所有伤害类型生效（默认关，仅近战攻击） */
    public static final ForgeConfigSpec.BooleanValue UNSTOPPABLE_SPEED_ALL_DAMAGE_TYPES;

    /** 唯快不破是否穿透护甲（默认关） */
    public static final ForgeConfigSpec.BooleanValue UNSTOPPABLE_SPEED_BYPASS_ARMOR;
    ...
    /** 便捷方法：获取定身粉碎阈值（单次伤害占最大血量的比例，0-1） */
